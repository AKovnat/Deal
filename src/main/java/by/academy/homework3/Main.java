    ...
    public static void main(String[] args) throws ParseException {
        ...
        while (true) {
            ...
            if (date.checkDate1(date1)){
                ...
                System.out.println("Вы неправильно ввели дату своего рождения. Повторите попытку.");
            }
        }
        ...
        while (true) {
            System.out.print("Еслм вы хотите добавить продукты в корзину введите 1\n" +
                    "Если вы хотите удалить продукт из корзины введите 2\n" +
                    "Если вы хотите просмотреть продукты в корзине введите 3: ");
